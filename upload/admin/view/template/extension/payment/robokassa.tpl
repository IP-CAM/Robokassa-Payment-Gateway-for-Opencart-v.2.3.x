	...
	<div class="page-header">
		<div class="container-fluid">
			<div class="pull-right">
				<button type="submit" form="form-robokassa" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary">
				...
				<form action="<?php echo $action ?>" method="post" enctype="multipart/form-data" id="form-payment" class="form-horizontal">
					...
					<div class="form-group">
						<label class="col-sm-2 control-label"
						       for="input-status_id"><?php echo $entry_order_status ?></label>
						<div class="col-sm-10">
					...
					<div class="form-group">
						<label class="col-sm-2 control-label"
						       for="input-order-test"><?php echo $entry_test ?></label>
						<div class="col-sm-10">
					...
					<div class="form-group hidden-fiscal" <?php if(!$robokassa_fiscal){ ?>style="display:none"<?php } ?> >
						<label class="col-sm-2 control-label"
						       for="input-order-tax-type"><?php echo $entry_tax_type ?></label>
						<div class="col-sm-10">
					...
					<div class="form-group">
						<label class="col-sm-2 control-label"
						       for="input-status-iframe"><span data-toggle="tooltip" title="<?php echo $help_iframe ?>"><?php echo $entry_iframe ?></span></label>
						<div class="col-sm-10">
...
<script>
	<?php if($robokassa_country == 'KZT'){ ?>
		$('#input-fiscal').attr('disabled','true');
	<?php } ?>
	...
	$('#input-country').on(
		...
		function ()
		{
			if ($(this).val() == 'KZT')
			{
				$("#input-fiscal option[value='0']").prop('selected', true);
				$('.hidden-fiscal').hide();
				$('#input-fiscal').attr('disabled','true');
			}
			else
			{
				$('#input-fiscal').removeAttr('disabled');
			}
		}
	);
